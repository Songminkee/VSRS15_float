...
CIYuv<PixelType>::CIYuv(int h, int w, int chroma_format)
{
  ...
  FuncFilter = NULL;
	...
	std::cout << "heightUV-----" << heightUV << std::endl;
	std::cout << "widthUV-----" << widthUV << std::endl;
	std::cout << "picsizeY-----" << picsizeY << std::endl;
	std::cout << "picsizeUV-----" << picsizeUV << std::endl;
	std::cout << "sizeof(PixelType)-----" << sizeof(PixelType) << std::endl;
