  ...
  for (i = 0; i < 3; i++)
  {
    ...
    while( fscanf(fp, "%s", id) == 1 )
    {
      ...
      if( strcmp(cameraId[i], id) == 0 )
      {
		...
		std::cout << &m_camParam[i].m_fExtrinsicMatrix[0][0]<<" " <<&m_camParam[i].m_fExtrinsicMatrix[0][1] << " " <<&m_camParam[i].m_fExtrinsicMatrix[0][2] << " " << &m_camParam[i].m_fTranslationVector[0] << std::endl;
		...
		std::cout << &m_camParam[i].m_fExtrinsicMatrix[1][0] << " " << &m_camParam[i].m_fExtrinsicMatrix[1][1] << " " << &m_camParam[i].m_fExtrinsicMatrix[1][2] << " " << &m_camParam[i].m_fTranslationVector[1] << std::endl;
		...
		std::cout << &m_camParam[i].m_fExtrinsicMatrix[2][0] << " " << &m_camParam[i].m_fExtrinsicMatrix[2][1] << " " << &m_camParam[i].m_fExtrinsicMatrix[2][2] << " " << &m_camParam[i].m_fTranslationVector[2] << std::endl;
        if(read!=23) return 0;
        found = 1;
      }
    }
